  ...
  return (
    ...
    <Section>
      <div className={styles.testimonialWrapper}>
        <h2 className={styles.heading}>Testimonials <br />& News</h2>
    ...
    <div className={styles.downloadContainer} >
      ...
      <div className={styles.download}>
        ...
        <p>Experience the best of cardtonic on your phone or tablet. Available for iOS and android operating system.</p>
        <Button><img src={apple} alt="" />Get on iphone</Button>
